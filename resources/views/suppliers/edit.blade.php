                            ...
                            <div class="card-body">
                                <div class="row row-cards">
                                    <div class="col-md-12">
                                        ...
                                        <x-input name="email" label="Dirección de correo electrónico" :value="old('email', $supplier->email)" :required="true"/>
                                        <x-input name="shopname" label="Nombre de la tienda" :value="old('shopname', $supplier->shopname)" :required="true"/>
                                        <x-input name="phone" label="Número de teléfono" :value="old('phone', $supplier->phone)" :required="true"/>
                                    </div>
