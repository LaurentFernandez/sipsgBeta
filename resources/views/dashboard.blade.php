...
document.addEventListener("DOMContentLoaded", function() {
    // Asumimos que 'myJsVar' contiene todas las variables necesarias
    var seriesData = [myJsVar.products, myJsVar.purchases, myJsVar.orders, myJsVar.quotations];
    ...
    window.ApexCharts && (new ApexCharts(document.getElementById('chart-demo-pie'), {
        ...
        series: seriesData, // Usamos el array modificado aquí
        labels: ["Productos", "Compras", "Pedidos", "Cotizaciones"],
        tooltip: {
            theme: 'dark'
        },
        grid: {
