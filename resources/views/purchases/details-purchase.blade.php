            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="row gx-3 mb-3">
                        <!-- Grupo del Formulario (nombre del proveedor) -->
                        <div class="col-md-6">
                            <label class="small mb-1">Nombre</label>
                            <div class="form-control form-control-solid">{{ $purchase->supplier->name }}</div>
                        </div>
                        <!-- Grupo del Formulario (email del proveedor) -->
                        <div class="col-md-6">
